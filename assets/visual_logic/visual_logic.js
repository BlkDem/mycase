...
function load_umbrella() {
  ...
  setHTMLElemAttribute('src', 'images/u1_200.png', 'case_current', false);
  setHTMLElemAttribute('src', 'images/red120.png', 'color_current', false);
...
function load_gamma() {
  ...
  setHTMLElemAttribute('src', 'images/g1_200.png', 'case_current', false);
  setHTMLElemAttribute('src', 'images/green120.png', 'color_current', false);
  setHTMLElemAttribute('className', 'show', 'id_clear', false);
  setHTMLElemAttribute('className', 'btn-group dropright show', 'cooler_color_current', false);
...
function load_diamond() {
  ...
  setHTMLElemAttribute('src', 'images/green120.png', 'color_current', false);
  setHTMLElemAttribute('src', 'images/d_200.png', 'case_current', false);
...
function load_diamondplus() {
  hidesidepanels();
  setHTMLElemAttribute('src', 'images/dp_200.png', 'case_current', false);
  setHTMLElemAttribute('className', 'hide', 'id_clear', false);
  setHTMLElemAttribute('className', 'btn-group dropright show', 'cooler_color_current', false);
  setHTMLElemAttribute('src', 'images/green120.png', 'color_current', false);
  setHTMLElemAttribute('innerHTML', 'Diamond+', 'id_caption', false);
...
eventHTMLElem('click', 'color_orange', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/white120.png', 'color_current', false);
...
eventHTMLElem('click', 'color_blue', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/blue120.png', 'color_current', false);
  set_link();
});
...
eventHTMLElem('click', 'cooler_color_red', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/cooler_red_front120.png', 'cooler_color_current', false);
});
eventHTMLElem('click', 'cooler_color_green', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/cooler_green_front120.png', 'cooler_color_current', false);
});
eventHTMLElem('click', 'cooler_color_blue', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/cooler_blue_front120.png', 'cooler_color_current', false);
});
eventHTMLElem('click', 'cooler_color_white', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/cooler_white_front120.png', 'cooler_color_current', false);
});
...
eventHTMLElem('click', 'panel_style_simple', false, function(event) {
  hidesidepanels();
  paneldesign = 'panel_style_simple';
  setHTMLElemAttribute('src', 'images/t_white120.png', 'panel_style_current', false);
  changeVis('clear_panel', true);
  changeVis('front_panel', true);
  setHTMLElemAttribute('href', 'https://s.click.aliexpress.com/e/_pziKLcR', 'id_link', false);
});
eventHTMLElem('click', 'panel_style_one', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/style_my.png', 'panel_style_current', false);
...
eventHTMLElem('click', 'panel_style_transf', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/style_transf.png', 'panel_style_current', false);
...
eventHTMLElem('click', 'panel_style_predator', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/style_predator.png', 'panel_style_current', false);
...
eventHTMLElem('click', 'panel_style_two', false, function(event) {
  ...
  setHTMLElemAttribute('src', 'images/style_two.png', 'panel_style_current', false);
