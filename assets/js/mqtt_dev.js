...
var websocketclient = {
    ...
    'connect': function () {
        ...
        var lwTopic = '/idx' + DeviceID + '/nvalue';
        var lwQos = 0;
        var lwRetain = false;
        var lwMessage = '';
        var ssl = false;
    ...
    'render': {
        ...
        'message': function (message) {
            ...
            if ($m !== "")
            {
				...
				if (typeof($($a).attr('suffix')) != "undefined")
				{
					console.log("suffix: " + $($a).attr('suffix'));
                  $($a).html(Encoder.htmlEncode($payload)+' '+$($a).attr('suffix'));
				}
				else
				{
					$($a).html(Encoder.htmlEncode($payload));
				}
